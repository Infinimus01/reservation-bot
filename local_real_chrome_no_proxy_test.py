...
PROFILE_DIR = str(Path.home() / "ndame-local-real-chrome-no-proxy")
...
async def main():
    async with async_playwright() as p:
        ...
        print("Opening tickets without proxy...")
        ...
        if is_challenge(html) or "csrf_name" not in html:
            print("If slider appears, solve it manually, then press Enter.")
            input("Press Enter after manual solve/check...")
